...
<div class="table-bg">
    <el-table :data="userlist">
        ...
        <el-table-column prop="username" label="管理员角色" align="center">
    ...
    <el-pagination @size-change="set_size" @current-change="set_page" :current-page="page" :page-sizes="[1, 2, 3, 4]" :page-size="size" layout="total, sizes, prev, pager, next, jumper" :total="total"></el-pagination>
</div>
</template>
